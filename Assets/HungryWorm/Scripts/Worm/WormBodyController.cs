...
namespace HungryWorm
{
    ...
    {
        [Header("HeadTarget")] [SerializeField]
        ...
        private int m_BodySegmentsCount = 5;
        ...
        private void WormEvents_WormDied()
        {
            m_IsDead = true;
        }
        ...
        private void CreateBody()
        {
            ...
            Vector3 tailPosition = m_PlayerTarget.position +
                                   Vector3.left * (m_DistanceBetweenSegments * m_BodySegmentsCount +
                                                   m_DistanceFromHead);
